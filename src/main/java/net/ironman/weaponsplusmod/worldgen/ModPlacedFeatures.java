...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> AMBER_GEODE_PLACED_KEY = registerKey("amber_geode_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, AMBER_GEODE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.AMBER_GEODE_KEY),
                List.of(RarityFilter.onAverageOnceEvery(65), InSquarePlacement.spread(),
                        HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(6), VerticalAnchor.absolute(75)),
                        BiomeFilter.biome()));
